...
public class MessageActivityForChild extends AppCompatActivity {
...
//                    startActivity(new Intent(MessageActivityForChild.this, ChatActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
//                }
//            });
...
//            mApiService = Client.getClient("https://fom.googleapis.com/").create(ApiServices.class);
            ...
            mDatabaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    readMessage(mChildId, UserId, user.getImageUrl());
            ...
            SendMessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!typeAMessage.equals("")){
                        sendMessage(mChildId, UserId, typeAMessage);
                    }else{
                        Toast.makeText(MessageActivityForChild.this, "You can't send empty messages", Toast.LENGTH_SHORT).show();
                    }
            ...
            mSeenListener = mDatabaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for(DataSnapshot mSnapshot: snapshot.getChildren()){
                        ...
                        if(chat.getReceiver().equals(mChildId) && chat.getSender().equals(UserID)){
        ...
        private void sendMessage(String Sender, final String Receiver, String Message){
            ...
            mReference = FirebaseDatabase.getInstance().getReference("Users").child(mChildId);
...
//
//                        Data mData = new Data(mChildId, R.mipmap.ic_launcher, username+": "+msg, "New Message", UserId);
//
...
//                                                Toast.makeText(MessageActivityForChild.this, "Failed", Toast.LENGTH_SHORT).show();
//                                            }
//                                        }
//                                    }
//
            ...
            mDatabaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for(DataSnapshot mSnapshot: snapshot.getChildren()){
                        ...
                        mMessageAdapter = new MessageAdapter(MessageActivityForChild.this, mChat, ImageUrl);
