...
public class CreateLocation extends AppCompatActivity implements
    ...
    private static final String TAG = CreateLocation.class.getSimpleName();
    ...
    private void addGeofence(GeofencingRequest request) {
        ...
        if (checkPermission())
            ...
            ).setResultCallback((ResultCallback<? super Status>) CreateLocation.this);
    }
